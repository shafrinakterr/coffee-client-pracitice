...
const UpdatedCoffee = () => {
    ...
    const {_id,coffeeName, chef, supplier, taste, category, details, photo}= updatedCoffee;



    const haddleUpdatedForm = e =>{
        e.preventDefault()
        const form = e.target;
        ...
        const updatedCoffee = {coffeeName, chef, supplier, taste, category, details, photo}
        ...
        .then(data=>{
            ...
            if(data.modifiedCount){
                const Toast = Swal.mixin({
                  ...
                  Toast.fire({
                    icon: 'success',
                    title: 'coffee upadeted successfully'
                  })
            }
        })
    }
    ...
    return (
        ...
        <div className="bg-[#F4F3F0] mt-10 p-4 md:p-24">
            <div className="text-center md:w-8/12 mx-auto space-y-5">
                <h1 className="font-ranco font-semibold text-4xl text-[] ">Update Existing Coffee Details</h1>
            ...
            <form onSubmit={haddleUpdatedForm} className="space-y-3">
                {/* form row */}
                <div className="md:flex gap-6 mt-10">
                    <div className="form-control md:w-1/2">
                        ...
                        <label>
                            <input type="text" defaultValue={coffeeName} placeholder='Enter coffee name' name="coffeeName" className="input w-full" />
                        </label>
                    </div>
                    <div className="form-control rounded-lg md:w-1/2">
                        ...
                        <label className=" ">
                            <input type="text" defaultValue={chef} name="chef" placeholder="Enter coffee chef" className="input  w-full" />
                        </label>
                    </div>
                </div>
                {/* form row */}
                <div className="md:flex gap-6 ">
                    <div className="form-control md:w-1/2">
                        ...
                        <label>
                            <input type="text" defaultValue={supplier} placeholder="Enter coffee supplier" name="supplier" className="input w-full" />
                        </label>
                    </div>
                    <div className="form-control rounded-lg md:w-1/2">
                        <label className="label">
                        ...
                        <label className=" ">
                            <input type="text" defaultValue={taste} name="taste" placeholder="Enter coffee taste" className="input  w-full" />
                        </label>
                    </div>
                </div>
                {/* form row */}
                <div className="md:flex gap-6 ">
                    <div className="form-control md:w-1/2">
                        ...
                        <label>
                            <input type="text" defaultValue={category} placeholder="Enter coffee category" name="category" className="input w-full" />
                        </label>
                    </div>
                    <div className="form-control rounded-lg md:w-1/2">
                        <label className="label">
                        ...
                        <label className=" ">
                            <input type="text" name="details" defaultValue={details}placeholder="Enter coffee details" className="input  w-full" />
                        </label>
                    </div>
                </div>
                <div className="md:flex gap-6 ">
                    <div className="form-control w-full">
                        ...
                        <label>
                            <input type="text" defaultValue={photo} placeholder="Enter coffee URL" name="photo" className="input w-full" />
                        </label>
                    </div>
                </div>
                <div className="md:flex gap-6">
